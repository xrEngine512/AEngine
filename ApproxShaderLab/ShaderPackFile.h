...
{
    ID_NONE, COMPILED_VS, COMPILED_PS, COMPILED_GS, COMPILED_CS, COMPILED_DS, COMPILED_HS, SAMPLER_DESC, INPUT_LAYOUT, IL_SEMANTIC_NAME, SHADER_NAME, BUFFER_DESC, BUFFER_PART_ID
};
