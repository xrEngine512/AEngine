...
LightShader::LightShader(void):m_lightBuffer(nullptr)
{
}
...
bool LightShader::CreateInputLayout(ID3D11Device* device, ID3DBlob* vertexShaderBuffer)
{
...
bool LightShader::CreateSamplerState(ID3D11Device* device)
{
	HRESULT result;
...
bool LightShader::SetupBuffers(ID3D11Device* device)
{
...
ShaderType LightShader::GetType()
{
	return LIGHT_SHADER;
}

bool LightShader::UpdateLight(ID3D11DeviceContext* context)
{
	HRESULT result;
