...
{
    IExternalRenderObject* AddRenderObject(const char *modelFileName, const ShaderDesc& type, float PosX = 0, float PosY = 0, float PosZ = 0, float RotX = 0, float RotY = 0, float RotZ = 0);
