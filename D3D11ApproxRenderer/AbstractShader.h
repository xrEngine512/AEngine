...
{
	class AbstractShader : public IStaticShader
	{
	private:
	...
	public:
		...
		bool Render(ID3D11DeviceContext* context, unsigned int indexCount, ID3D11ShaderResourceView** textures, const GenericStruct*)override;
	};
}
