...
namespace ShaderSystem
{
	...
	{
		InitializeShader(device, L"../D3D11ApproxRenderer/Shaders/Wireframe/VertexShader.hlsl", L"../D3D11ApproxRenderer/Shaders/Wireframe/PixelShader.hlsl", 0, L"../D3D11ApproxRenderer/Shaders/Wireframe/GeometryShader.hlsl");
		m_desc.name = "WireFrame";
		m_desc.TextureSlots = 0;
	}
